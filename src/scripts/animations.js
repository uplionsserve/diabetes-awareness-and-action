	...
	$(".contactButton").hover(
		function () {
			gsap.to($(this), {
				duration: 0.4,
				y: -10,
				backgroundColor: "rgb(200,235,244)",
				ease: "power2"
			})
			gsap.to($("img", this), {
				duration: 0.3,
		...
		function () {
			gsap.to($(this), {
				duration: 0.4,
				y: 0,
				backgroundColor: "rgb(140, 213, 232)",
				ease: "bounce"
			})
			gsap.to($("img", this), {
				duration: 0.3,
